<div class="table-responsive">
    <table class="table" id="attendances-table">
        ...
        @foreach($attendances as $attendances)
            ...
            <td>{{ $attendances->attendance_statut }}</td>
                <td width="120">
                    {!! Form::open(['route' => ['attendances.destroy', $attendances->attendance_id], 'method' => 'delete']) !!}
                    <div class='btn-group'>
                        <a href="{{ route('attendances.show', [$attendances->attendance_id]) }}" class='btn btn-default btn-xs'>
                            <i class="far fa-eye"></i>
                        </a>
                        <a href="{{ route('attendances.edit', [$attendances->attendance_id]) }}" class='btn btn-default btn-xs'>
